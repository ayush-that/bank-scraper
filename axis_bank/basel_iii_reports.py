...
url = "https://www.axisbank.com/shareholders-corner/regulatory-disclosure/basel-iii-disclosures"
...
if response.status_code == 200:
    ...
    save_directory = "axis_bank_basel_iii_reports"
    ...
    for link in links:
        ...
        if relative_url.startswith("/docs/default-source/regulatory-disclosure-section/"):
